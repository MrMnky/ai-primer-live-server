/* ============================================
   ...
   For local dev: edit the values below.
   For production: these are injected at build
   time or loaded from /api/config.
   ============================================ */
...
const CONFIG = {
  ...
  SERVER_URL: 'https://ai-primer-live-server-production.up.railway.app',
